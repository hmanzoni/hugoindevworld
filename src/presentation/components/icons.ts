...
export const arrIcons: IconConfig[] = [
  { iconName: 'UilMessage' },
  ...
  { iconName: 'UilTimes', propsIcon: { className: 'services__modal-close' } },
  { iconName: 'UilBracketsCurly', propsIcon: { className: 'skills__icon' } },
  { iconName: 'UilStar', propsIcon: { className: 'testimonial__icon-star' } },
  { iconName: 'UilCloudDatabaseTree', propsIcon: { className: 'services__icon' }, iconSize: sizeIcons },
  { iconName: 'UilWebGrid', propsIcon: { className: 'services__icon' }, iconSize: sizeIcons },
  { iconName: 'UilServer', propsIcon: { className: 'services__icon' }, iconSize: sizeIcons },
  ...
  { iconName: 'UilAngleDown', propsIcon: { className: 'skills__arrow' }, iconSize: sizeIcons },
